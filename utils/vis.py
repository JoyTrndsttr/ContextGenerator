...
def vis_slicing(repo):
    # Load the slicing JSON file
    file_path = f"/data/DataLACP/wangke/recorebench/workspace/{repo}/slicing.json"
    output_path = f"/data/DataLACP/wangke/recorebench/workspace/{repo}/slice_visualization.png"
